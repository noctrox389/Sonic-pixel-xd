...
-----------------------------------------------------------------------
	...
	--ARTWORK TEXT
	makeLuaText('ARTISTS', 'SPRITES', 1000, 132, -1000)
	...
	--CHARTING TEXT
	makeLuaText('CHARTERS', 'CHARTERS', 1000, 132, -1000)
...
-----------------------------------------------------------------------
	...
	--CODER 
	makeLuaText('CODER1', 'RamenDominoes - Credit Script', 1000, 132, -1000)
	setTextAlignment('CODER1', 'center')
	setTextSize('CODER1', 25)
	setObjectCamera('CODER1', 'other')
	addLuaText('CODER1')

	makeLuaText('CODER2', 'Gavman22 - Pause Script', 1000, 132, -1000)
	setTextAlignment('CODER2', 'center')
	setTextSize('CODER2', 25)
	setObjectCamera('CODER2', 'other')
	addLuaText('CODER2')

	makeLuaText('CODER3', 'Jackie.exe - OG Coder', 1000, 132, -1000)
...
--------ARTIST CREW--------
	...
	--ARTIST 1
	makeLuaText('ARTIST1', 'me', 1000, 132, -1000)
	...
	--ARTIST 2
	makeLuaText('ARTIST2', 'lithium', 1000, 132, -1000)
	...
	--MUSICIAN 1
	makeLuaText('MUSICIAN1', 'Saster', 1000, 132, -1000)
	...
	--MUSICIAN 2
	makeLuaText('MUSICIAN2', 'MarStarBro', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER1', 'Wilde - OG Charter', 1000, 132, -1000)
	...
	--CHARTER 1
	makeLuaText('CHARTER2', 'Silicosis - Rechart', 1000, 132, -1000)
