function onCreate()
	...
	makeAnimatedLuaSprite('snow', 'snow', -1000, -700)
	scaleObject('snow', 8, 8);
	setLuaSpriteScrollFactor('snow', 0.9, 0.9);
	addAnimationByPrefix('snow', 'snow', 'snow', 15, true)
	objectPlayAnimation('snow', 'snow', true)
